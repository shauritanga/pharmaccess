                            ...
                            <div class="row gx-3">
                                <div class="col-xxl-3 col-lg-4 col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="a1" value=""
                                            placeholder="Enter hospital name">
                                    </div>
                                </div>
                                <div class="col-xxl-3 col-lg-4 col-sm-6">
                                    <div class="mb-3">
                                        <label class="form-label" for="a2">Hospital Contact</label>
                                        <input type="email" class="form-control" id="a2" value=""
                                            placeholder="Enter hospital contact personnel">
                                    </div>
                                </div>
                                <div class="col-xxl-3 col-lg-4 col-sm-6">
                                    <div class="mb-3">
                                ...
                                <div class="col-xxl-3 col-lg-4 col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="a4" value=""
